                    ...
                    {user.role === "user" && (
                        <>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={() => navigate(`/profile/claim-insurance/${insurance._id}`)}
                                className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center "
                            >
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <DetailRow
                                        label="Start Date"
                                        value={formatDate(insurance.policyDetails.seasonDates.startDate)}
                                        icon={Calendar}
                                    />
                                    <DetailRow
                                        label="End Date"
                                        value={formatDate(insurance.policyDetails.seasonDates.endDate)}
                                        icon={Calendar}
                                    />
                                </div>
                            </div>
                ...
                <div className="space-y-6">
                    ...
                    <InfoSection title="Required Documents" icon={FileText}>
                        <ul className="space-y-2">
                            {insurance.insurancePolicy.eligibility.requiredDocuments.map((doc, index) => (
                    ...
                    <InfoSection title="Important Dates" icon={Clock}>
                        <div className="space-y-4">
                            ...
                            <DetailRow
                                ...
                                value={formatDate(insurance.insuranceAssignment.applicationDate)}
                            />
                        </div>
                    </InfoSection>
                </div>
