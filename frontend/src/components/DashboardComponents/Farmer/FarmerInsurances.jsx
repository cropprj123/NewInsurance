...
const InsuranceCard = ({ insurance }) => {
    ...
    const startDate = new Date(insurance.policyDetails.seasonDates.startDate).toLocaleDateString('en-IN', {
        day: 'numeric',
        month: 'long',
        year: 'numeric'
    });
    const endDate = new Date(insurance.policyDetails.seasonDates.endDate).toLocaleDateString('en-IN', {
        day: 'numeric',
        month: 'long',
        year: 'numeric'
    });
            ...
            <div className="p-8">
                ...
                <div className="flex justify-between items-start mb-8">
                    ...
                    <motion.span
                        ...
                        className={`px-5 py-2.5 rounded-full text-sm font-semibold ${insurance.status === 'active'
                    ...
                    <div className="p-6 bg-gradient-to-br from-mycol-nyanza/20 to-transparent rounded-xl">
                        <div className="space-y-4">
                            <div className="flex items-center space-x-3 mb-4">
                                ...
                                <p className="text-lg font-semibold text-gray-900">Season Period</p>
                            </div>
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-md font-medium text-gray-900">
                                    {insurance.cropDetails[0].cropCategory} - {insurance.cropDetails[0].crops[0].cropType}
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-md font-medium text-gray-900">
                                    {insurance.farmerDetails.address.district}, {insurance.farmerDetails.address.state}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-md font-medium text-gray-900">{insurance.agent.name}</p>
...
const QuickStats = ({ insurances }) => {
    ...
    const totalInsured = insurances.reduce((sum, i) => sum + i.policyDetails.sumInsured, 0);
